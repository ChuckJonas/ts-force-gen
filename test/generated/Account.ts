...
import { AccountHistory, Contact } from "./";
...
export class Account extends RestObject {
    @sField({ apiName: 'Histories', createable: false, updateable: false, required: false, reference: () => { return AccountHistory }, childRelationship: true, salesforceType: SalesforceFieldType.REFERENCE, salesforceLabel: 'Histories', externalId: false })
    public histories: AccountHistory[];
